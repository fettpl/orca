/**
 * Git porcelain/diff helpers extracted from git-handler.ts.
 *
 * Why: oxlint max-lines requires files to stay under 300 lines.
 * Branch-diff helpers are pure; `parseUnmergedEntry` is a shared re-export
 * that probes the worktree filesystem.
 */
...
export { parseWorktreeList } from '../shared/git-worktree-list-parser'
export { parseUnmergedEntry } from '../shared/git-unmerged-entry'
